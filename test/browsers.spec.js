 ...
 */
function testFixture(browsers, expectThrows){
...
it('Valid: ["last 2 versions"]', testFixture.bind(null, ['last 2 versions'], false));
it('Invalid: ["dummy"]', testFixture.bind(null, ['dummy'], true));
