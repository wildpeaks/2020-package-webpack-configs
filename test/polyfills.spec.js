 ...
 */
function testFixture(polyfills, expectThrows){
...
it('Valid: ["./hello.js", "world"]', testFixture.bind(null, ['./hello.js', 'world'], false));
it('Valid: []', testFixture.bind(null, [], false));
it('Invalid: "./hello.js"', testFixture.bind(null, './hello.js', true));
